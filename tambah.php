...
<body>
	...
	<?php 
		if(isset($_POST['submit'])){
			...
			$query = mysqli_query($conn, "INSERT INTO crud (nama, no_hp, email, alamat) VALUES('$nama','$no_hp','$email', '$alamat')");
			
			if($query){
				header('Location: crud.php?status=berhasil&from=tambah');
			}
			else{
				header('Location: crud.php?status=gagal&from=tambah');
			}
